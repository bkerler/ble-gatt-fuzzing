...
class Scenario2Client(Scenario):
    """Scenario 2 Client side

    Send Responses PDUs without prior Requests
    """
    ...
    def run(self, central: Central, bt_addr: str, is_addr_random: bool, post_url: str, gatt_handle: list[int]):
        ...
        while True:
            ...
            try :
                ...
                my_pdu, ATT_layer = Fuzz.mutator("Response", gatt_handle) # Craft a Response pdu
...
class Scenario2Server(Scenario):
    """Scenario 2 Server side
    ...
    def run(self, periph: PeripheralClient, post_url: str, gatt_handle: list[int]):
        ...
        while periph.is_connected():
            ...
            try :
                ...
                my_pdu, _ = Fuzz.mutator("Response", gatt_handle)    # Craft a Response pdu
