...
class Scenario4Server(Scenario):
    """Scenario 4 Server side

    Return unsorted handle lists
    """
    def __init__(self):
        super().__init__()
...
class CustomGattScenario4(GattServer):
    ...
    def on_read_by_group_type_request(self, request: GattReadByGroupTypeRequest):
        ...
        print("on_read_by_group_type_request before shuffle(attrs_handles):", attrs_handles)
        shuffle(attrs_handles)
        print("on_read_by_group_type_request after shuffle(attrs_handles):", attrs_handles)
